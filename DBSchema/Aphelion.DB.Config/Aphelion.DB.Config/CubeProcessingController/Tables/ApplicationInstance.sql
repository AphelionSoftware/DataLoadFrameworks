CREATE TABLE [CubeProcessingController].[ApplicationInstance] (
    ...
    CONSTRAINT [FK_ApplicationInstance_Application] FOREIGN KEY ([ApplicationID]) REFERENCES [CubeProcessingController].[Application] ([ID]),
