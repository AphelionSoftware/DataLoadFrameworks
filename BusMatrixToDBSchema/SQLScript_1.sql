/****** Object:  Database Okavango    Script Date: 1/3/2014 10:24:31 PM ******/
...
/* Drop table DimUnitConversion */
IF OBJECT_ID('Shared.DimUnitConversion')IS NOT NULL
DROP TABLE DimUnitConversion;
GO


/* Create table Shared.DimUnitConversion */
CREATE TABLE Shared.DimUnitConversion
(
   DimUnitConversionID INT NOT NULL,
   RunID INT NOT NULL
);
GO


ALTER TABLE Shared.DimUnitConversion
ADD CONSTRAINT pk_DimUnitConversionID
PRIMARY KEY CLUSTERED
(
   DimUnitConversionID
);
...
exec sys.sp_addextendedproperty
@name=N'DisplayName',
@value=N'Financial Amount',
@level0type=N'SCHEMA',
@level0name=N'Costs',
@level1type=N'TABLE',
@level1name=N'FactBudget',
@level2type=N'COLUMN',
@level2name=N'Financial Amount';
GO
...
/* Drop table FactCOA */
IF OBJECT_ID('Costs.FactCOA')IS NOT NULL
DROP TABLE FactCOA;
GO


/* Create table Costs.FactCOA */
CREATE TABLE Costs.FactCOA
(
   FactCOAID INT NOT NULL,
   DimDateID INT,
   DimCostTypeID INT,
   DimOrganisationID INT,
...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT pk_FactCOAID
PRIMARY KEY CLUSTERED
(
   FactCOAID
);
...
--Add UNIQUE Constraints...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT uc_FactCOA_DimDateID
UNIQUE
(
   DimDateID
)
...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT uc_FactCOA_DimCostTypeID
UNIQUE
(
   DimCostTypeID
)
...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT uc_FactCOA_DimOrganisationID
UNIQUE
(
   DimOrganisationID
)
...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT uc_FactCOA_DimChartOfAccountsID
UNIQUE
(
...
ALTER TABLE Costs.FactCOA
ADD CONSTRAINT uc_FactCOA_DimCurrencyID
UNIQUE
(
   DimCurrencyID
)
